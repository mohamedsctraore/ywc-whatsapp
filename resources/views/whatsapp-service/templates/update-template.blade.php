...
<div class="container-fluid mt-lg--6">
    ...
    buttonModels:{
        @if(isset($templateButtons['buttons']) and !empty($templateButtons['buttons']))
        @foreach ($templateButtons['buttons'] as $templateComponentButton)
        '{{ $loop->index + 1 }}' : '{{ $templateComponentButton['text'] }}',
       @endforeach
       @endif
       },
    customButtons:{
                ...
                <div class="row">
                    <div class="col-md-7">
                        <fieldset>
                            ...
                            <dl>
                                <dt>{{  __tr('Template Name') }}</dt>
                                <dd>{{ $whatsAppTemplateData['name'] }}</dd>
                                <dt>{{  __tr('Template Language') }}</dt>
...
<script>
 ...
 @if($templateComponent['type'] == 'HEADER')
    ...
    @endif
     ...
     __DataRequest.updateModels({text_body:`{{ $templateComponent['text'] }}`});
     _.defer(function(){
